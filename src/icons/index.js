...
//baru 
import { ReactComponent as UserAddIcon } from "./add-user.svg?react";
import { ReactComponent as RoleIcon } from "./role.svg?react";
import { ReactComponent as ContractIcon } from "./contract.svg?react";
import { ReactComponent as PeopleMinusIcon } from "./people-minus.svg?react";
import { ReactComponent as ShiftIcon } from "./shift.svg?react";
import { ReactComponent as DivisionIcon } from "./division.svg?react";
import { ReactComponent as LocationIcon } from "./location.svg?react";
import { ReactComponent as RekapDataIcon } from "./rekap-data.svg?react";
import { ReactComponent as CutiIcon } from "./cuti.svg?react";
import { ReactComponent as AbsensiIcon } from "./absensi.svg?react";
import { ReactComponent as OvertimeIcon } from "./overtime.svg?react";
import { ReactComponent as PatroliIcon } from "./patroli.svg?react";
import { ReactComponent as VisitIcon } from "./visit.svg?react";
import { ReactComponent as PenugasanIcon } from "./penugasan.svg?react";
import { ReactComponent as RapatIcon } from "./rapat.svg?react";
import { ReactComponent as KinerjaIcon } from "./kinerja.svg?react";
import { ReactComponent as LaporanIcon } from "./laporan-kerja.svg?react";
import { ReactComponent as InventoryIcon } from "./inventory.svg?react";
import { ReactComponent as KeuanganIcon } from "./keuangan.svg?react";
import { ReactComponent as TargetIcon } from "./target.svg?react";
import { ReactComponent as DokumenPegawaiIcon } from "./dokumen-pegawai.svg?react";
import { ReactComponent as InformationIcon } from "./information.svg?react";
import { ReactComponent as SettingsIcon } from "./settings.svg?react";
import { ReactComponent as CompanyIcon } from "./company.svg?react";
import { ReactComponent as FaceRecogIcon } from "./company.svg?react";
export { 
//baru 
UserAddIcon, RoleIcon, ContractIcon, PeopleMinusIcon, ShiftIcon, DivisionIcon, LocationIcon, RekapDataIcon, CutiIcon, AbsensiIcon, OvertimeIcon, PatroliIcon, VisitIcon, PenugasanIcon, RapatIcon, KinerjaIcon, LaporanIcon, InventoryIcon, KeuanganIcon, TargetIcon, DokumenPegawaiIcon, InformationIcon, SettingsIcon, CompanyIcon, FaceRecogIcon, 
//lama
ErrorHexaIcon, AlertHexaIcon, MoreDotIcon, DownloadIcon, FileIcon, GridIcon, AudioIcon, VideoIcon, BoltIcon, PlusIcon, BoxIcon, CloseIcon, CheckCircleIcon, AlertIcon, InfoIcon, ErrorIcon, ArrowUpIcon, FolderIcon, ArrowDownIcon, ArrowRightIcon, GroupIcon, BoxIconLine, ShootingStarIcon, DollarLineIcon, TrashBinIcon, AngleUpIcon, AngleDownIcon, PencilIcon, CheckLineIcon, CloseLineIcon, ChevronDownIcon, PaperPlaneIcon, EnvelopeIcon, LockIcon, UserIcon, CalenderIcon, EyeIcon, EyeCloseIcon, TimeIcon, CopyIcon, ChevronLeftIcon, UserCircleIcon, TaskIcon, ListIcon, TableIcon, PageIcon, PieChartIcon, BoxCubeIcon, PlugInIcon, DocsIcon, MailIcon, HorizontaLDots, ChevronUpIcon, ChatIcon, AngleLeftIcon, AngleRightIcon, };
