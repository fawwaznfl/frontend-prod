...
export default function AddKontrak() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (kontrak.file)
                formData.append("file", kontrak.file);
    ...
    const CustomInput = ({ value, onClick }) => (_jsx("button", { onClick: onClick, type: "button", className: "\n      border px-3 py-2 rounded-md w-full text-left bg-white text-gray-900 \n      hover:border-blue-500\n      dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600 dark:hover:border-blue-400\n    ", children: value || "Pilih tanggal" }));
    return (_jsxs(_Fragment, { children: [_jsx(PageMeta, { title: "Add-Kontrak", description: "Add Kontrak" }), _jsx(PageHeader, { pageTitle: "Tambah Kontrak", titleClass: "text-[32px] dark:text-white", rightContent: _jsx("button", { onClick: () => navigate("/kontrak"), className: "bg-gray-500 hover:bg-gray-600 text-white font-medium px-5 py-2 rounded-xl", children: "\u2B05 Back" }) }), _jsx("div", { className: "space-y-5 sm:space-y-6 mt-4", children: _jsx(ComponentCard, { title: "Form Tambah Kontrak", children: _jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [dashboardType === "superadmin" && (_jsxs("div", { children: [_jsx(Label, { children: "Company" }), _jsxs("select", { name: "company_id", value: kontrak.company_id, onChange: handleChange, className: "w-full border px-3 py-2 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white", children: [_jsx("option", { value: "", children: "-- Pilih Company --" }), companies.map((c) => (_jsx("option", { value: c.id, children: c.name }, c.id)))] }), errors.company_id && _jsx("p", { className: "text-red-500", children: errors.company_id })] })), _jsxs("div", { children: [_jsx(Label, { htmlFor: "pegawai_id", children: "Nama Pegawai" }), _jsxs("select", { id: "pegawai_id", name: "pegawai_id", value: kontrak.pegawai_id, onChange: handleChange, className: "w-full border px-3 py-2 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white", children: [_jsx("option", { value: "", children: "-- Pilih Pegawai --" }), filteredPegawai.map((p) => (_jsx("option", { value: p.id, children: p.name }, p.id)))] }), errors.pegawai_id && (_jsx("p", { className: "text-red-500", children: errors.pegawai_id }))] }), _jsxs("div", { children: [_jsx(Label, { htmlFor: "jenis_kontrak", children: "Jenis Kontrak" }), _jsx("select", { id: "jenis_kontrak", name: "jenis_kontrak", value: kontrak.jenis_kontrak, onChange: handleChange, required: true, className: "w-full border px-3 py-2 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white", children: jenisKontrakOptions.map((option) => (_jsx("option", { value: option, children: option }, option))) })] }), _jsxs("div", { children: [_jsx(Label, { htmlFor: "tanggal_mulai", children: "Tanggal Mulai" }), _jsx(DatePicker, { selected: tanggalMulai, onChange: (date) => {
                                            setTanggalMulai(date);
                                            setKontrak((prev) => ({
                                                ...prev,
                                                tanggal_mulai: date ? date.toISOString().split("T")[0] : ""
                                            }));
                                        }, dateFormat: "yyyy-MM-dd", customInput: _jsx(CustomInput, {}) }), errors.tanggal_mulai && (_jsx("p", { className: "text-red-500", children: errors.tanggal_mulai }))] }), _jsxs("div", { children: [_jsx(Label, { htmlFor: "tanggal_selesai", children: "Tanggal Selesai" }), _jsx(DatePicker, { selected: tanggalSelesai, onChange: (date) => {
                                            setTanggalSelesai(date);
                                            setKontrak((prev) => ({
                                                ...prev,
                                                tanggal_selesai: date ? date.toISOString().split("T")[0] : ""
                                            }));
                                        }, dateFormat: "yyyy-MM-dd", customInput: _jsx(CustomInput, {}) }), errors.tanggal_selesai && (_jsx("p", { className: "text-red-500", children: errors.tanggal_selesai }))] }), _jsxs("div", { children: [_jsx(Label, { htmlFor: "keterangan", children: "Keterangan" }), _jsx("textarea", { id: "keterangan", name: "keterangan", value: kontrak.keterangan, onChange: handleChange, className: "border px-3 py-2 rounded-md w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white", placeholder: "Masukkan keterangan kontrak (opsional)" })] }), _jsxs("div", { children: [_jsx(Label, { children: "File Kontrak" }), _jsx("div", { className: "border-2 border-dashed rounded p-4 flex flex-col items-center justify-center cursor-pointer hover:border-blue-500 relative", children: !kontrak.file ? (_jsxs(_Fragment, { children: [_jsx("p", { className: "text-gray-500", children: "Klik untuk pilih file atau drag file di sini" }), _jsx("input", { type: "file", name: "file", onChange: handleChange, required: true, className: "absolute inset-0 opacity-0 cursor-pointer" })] })) : (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { children: kontrak.file.name }), _jsx("button", { type: "button", onClick: handleRemoveFile, className: "text-red-500 font-bold", children: "\u2716" })] })) })] }), _jsx("div", { className: "flex justify-end", children: _jsx("button", { type: "submit", disabled: loading, className: `${loading ? "bg-blue-400" : "bg-blue-600 hover:bg-blue-700"} text-white font-medium px-6 py-2 rounded-xl`, children: loading ? "Menyimpan..." : "Save" }) })] }) }) })] }));
}
