...
export default function EditDokumen() {
    ...
    if (detailLoading) {
        return _jsx("p", { className: "text-gray-600 dark:text-gray-300", children: "Loading data..." });
    }
    return (_jsxs(_Fragment, { children: [_jsx(PageMeta, { title: "Edit Dokumen Pegawai", description: "Edit dokumen pegawai" }), _jsx(PageHeader, { pageTitle: "Edit Dokumen Pegawai", titleClass: "text-[32px] dark:text-white", rightContent: _jsx("button", { onClick: () => navigate("/dokumen-pegawai"), className: "bg-gray-500 hover:bg-gray-600 text-white font-medium px-5 py-2 rounded-xl", children: "\u2B05 Back" }) }), _jsx("div", { className: "space-y-5 mt-4", children: _jsx(ComponentCard, { title: "Form Edit Dokumen Pegawai", children: _jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [user.dashboard_type === "superadmin" && (_jsxs("div", { children: [_jsx(Label, { children: "Company" }), _jsxs("select", { name: "company_id", value: form.company_id, onChange: handleChange, className: "w-full border px-3 py-2 rounded", children: [_jsx("option", { value: "", children: "-- Pilih Company --" }), companies.map((c) => (_jsx("option", { value: c.id, children: c.name }, c.id)))] }), errors.company_id && (_jsx("p", { className: "text-red-500", children: errors.company_id }))] })), _jsxs("div", { children: [_jsx(Label, { className: "dark:text-gray-200", children: "Pegawai" }), _jsxs("select", { name: "pegawai_id", value: form.pegawai_id, onChange: handleChange, className: "w-full border px-3 py-2 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white", children: [_jsx("option", { value: "", children: "-- Pilih Pegawai --" }), filteredPegawai.map((p) => (_jsx("option", { value: p.id, children: p.name }, p.id)))] }), errors.pegawai_id && _jsx("p", { className: "text-red-500", children: errors.pegawai_id })] }), _jsxs("div", { children: [_jsx(Label, { className: "dark:text-gray-200", children: "Nama Dokumen" }), _jsx(Input, { name: "nama_dokumen", value: form.nama_dokumen, onChange: handleChange, placeholder: "Masukkan nama dokumen", className: "dark:bg-gray-700 dark:text-white" }), errors.nama_dokumen && _jsx("p", { className: "text-red-500", children: errors.nama_dokumen })] }), _jsxs("div", { children: [_jsx(Label, { className: "dark:text-gray-200", children: "Keterangan" }), _jsx("textarea", { name: "keterangan", value: form.keterangan, onChange: handleChange, className: "border px-3 py-2 rounded w-full dark:bg-gray-700 dark:text-white", placeholder: "Opsional" })] }), _jsxs("div", { children: [_jsx(Label, { className: "dark:text-gray-200", children: "File Dokumen" }), _jsx("div", { className: "\n                  border-2 border-dashed rounded p-4 relative flex flex-col items-center justify-center cursor-pointer\n                  bg-gray-50 hover:bg-gray-100 border-gray-300\n                  dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-600\n                ", children: !form.file ? (_jsxs(_Fragment, { children: [_jsx("p", { className: "text-gray-600 dark:text-gray-300 text-sm", children: "Klik untuk pilih file" }), _jsx("input", { type: "file", name: "file", onChange: handleChange, className: "absolute inset-0 opacity-0 cursor-pointer" })] })) : (_jsxs("div", { className: "flex gap-2 items-center", children: [_jsx("span", { className: "text-gray-800 dark:text-gray-100", children: form.file.name }), _jsx("button", { type: "button", className: "text-red-500", onClick: handleRemoveFile, children: "\u2716" })] })) }), existingFile && !form.file && (_jsxs("div", { className: "mt-2 p-3 rounded-lg border bg-blue-50 border-blue-200 dark:bg-blue-900/30 dark:border-blue-800", children: [_jsx("p", { className: "text-sm text-gray-700 dark:text-gray-200", children: "File Saat Ini:" }), _jsx("a", { href: existingFile, target: "_blank", className: "text-blue-600 dark:text-blue-400 underline text-sm", children: "Lihat File" })] }))] }), _jsx("div", { className: "flex justify-end", children: _jsx("button", { type: "submit", disabled: loading, className: `${loading ? "bg-blue-400" : "bg-blue-600 hover:bg-blue-700"} text-white px-6 py-2 rounded-xl`, children: loading ? "Menyimpan..." : "Update" }) })] }) }) })] }));
}
