...
export default function AllMenuPegawai() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 pb-12 rounded-b-[32px] shadow", children: [_jsxs("div", { className: "flex items-center", children: [_jsx("button", { onClick: () => navigate(user.dashboard_type === "pegawai"
                                    ? "/home-pegawai"
                                    : "/pegawai"), className: "w-9 h-9 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/30 transition", children: _jsx("span", { className: "text-xl font-semibold", children: "\u2190" }) }), _jsx("h1", { className: "flex-1 text-center text-lg font-semibold tracking-wide", children: "All Menu" }), _jsx("div", { className: "w-9" })] }), _jsxs("p", { className: "mt-4 text-sm text-white/80 text-center", children: ["Lokasi: ", _jsx("span", { className: "font-medium", children: lokasiName })] })] }), _jsx("div", { className: "-mt-8 px-4 pb-6", children: _jsx("div", { className: "bg-white rounded-3xl shadow-lg p-5", children: _jsx("div", { className: "grid grid-cols-4 gap-y-6 gap-x-4 text-center", children: menus.map((m, i) => (_jsxs("div", { onClick: () => {
                                if (m.label === "Logout") {
                                    handleLogout();
                                }
                                else if (m.link) {
                            ...
                            }, className: "flex flex-col items-center gap-2 cursor-pointer group", children: [_jsx("div", { className: "w-16 h-16 rounded-2xl bg-gray-50 shadow flex items-center justify-center\n                                transition-all duration-200\n                                group-hover:shadow-lg group-hover:-translate-y-1\n                                active:scale-95", children: _jsx("img", { src: m.img, alt: m.label, className: "w-7 h-7" }) }), _jsx("p", { className: "text-xs font-medium text-gray-700 leading-tight", children: m.label })] }, i))) }) }) })] }));
}
